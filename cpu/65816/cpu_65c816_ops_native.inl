...
// 10
OP(BPL) OP(OpOr<AddrDirectIndirectY<OP_A, OP_XY>>) OP(OpOr<AddrDirectIndirect<OP_A, OP_XY>>) OP(OpOr<AddrStackY<OP_A, OP_XY>>)
...
// 30
OP(BMI) OP(OpAnd<AddrDirectIndirectY<OP_A, OP_XY>>) OP(OpAnd<AddrDirectIndirect<OP_A, OP_XY>>) OP(OpAnd<AddrStackY<OP_A, OP_XY>>)
...
// 50
OP(BVC) OP(OpXor<AddrDirectIndirectY<OP_A, OP_XY>>) OP(OpXor<AddrDirectIndirect<OP_A, OP_XY>>) OP(OpXor<AddrStackY<OP_A, OP_XY>>)
...
// 70
OP(BVS) OP(OpAdc<AddrDirectIndirectY<OP_A, OP_XY>>) OP(OpAdc<AddrDirectIndirect<OP_A, OP_XY>>) OP(OpAdc<AddrStackY<OP_A, OP_XY>>)
...
// 90
OP(BCC) OP(STA<AddrDirectIndirectY<OP_A, OP_XY>>) OP(STA<AddrDirectIndirect<OP_A, OP_XY>>) OP(STA<AddrStackY<OP_A, OP_XY>>)
...
// 98
OP(TYA<OP_A, OP_XY>) OP(STA<AddrAbsY<OP_A, OP_XY>>) OP(TXS<false>) OP(TXY<OP_A, OP_XY>)
...
// B0
OP(BCS) OP(LDA<AddrDirectIndirectY<OP_A, OP_XY>>) OP(LDA<AddrDirectIndirect<OP_A, OP_XY>>) OP(LDA<AddrStackY<OP_A, OP_XY>>)
...
// D0
OP(BNE) OP(OpCmp<AddrDirectIndirectY<OP_A, OP_XY>>) OP(OpCmp<AddrDirectIndirect<OP_A, OP_XY>>) OP(OpCmp<AddrStackY<OP_A, OP_XY>>)
...
// F0
OP(BEQ) OP(OpSbc<AddrDirectIndirectY<OP_A, OP_XY>>) OP(OpSbc<AddrDirectIndirect<OP_A, OP_XY>>) OP(OpSbc<AddrStackY<OP_A, OP_XY>>)
