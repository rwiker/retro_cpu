...
OP(OpTrb<AddrAbs<OP_A, OP_XY>>) OP(OpOr<AddrAbsX<OP_A, OP_XY>>) OP(OpAsl<AddrAbsX<OP_A, OP_XY>>) OP(OpOr<AddrAbsLongX<OP_A, OP_XY>>)
// 20
...
OP(OpBit<AddrAbsX<OP_A, OP_XY>>) OP(OpAnd<AddrAbsX<OP_A, OP_XY>>) OP(OpRol<AddrAbsX<OP_A, OP_XY>>) OP(OpAnd<AddrAbsLongX<OP_A, OP_XY>>)
// 40
...
OP(JMP_LONG) OP(OpXor<AddrAbsX<OP_A, OP_XY>>) OP(OpLsr<AddrAbsX<OP_A, OP_XY>>) OP(OpXor<AddrAbsLongX<OP_A, OP_XY>>)
// 60
...
OP(JMP_INDABSX) OP(OpAdc<AddrAbsX<OP_A, OP_XY>>) OP(OpRor<AddrAbsX<OP_A, OP_XY>>) OP(OpAdc<AddrAbsLongX<OP_A, OP_XY>>)
// 80
...
// 90
OP(BCC) OP(STA<AddrDirectIndirectY<OP_A, OP_XY, true>>) OP(STA<AddrDirectIndirect<OP_A, OP_XY>>) OP(STA<AddrStackY<OP_A, OP_XY>>)
...
// 98
OP(TYA<OP_A, OP_XY>) OP(STA<AddrAbsY<OP_A, OP_XY>>) OP(TXS<true>) OP(TXY<OP_A, OP_XY>)
OP(STZ<AddrAbs<OP_A, OP_XY>>) OP(STA<AddrAbsX<OP_A, OP_XY>>) OP(STZ<AddrAbsX<OP_A, OP_XY>>) OP(STA<AddrAbsLongX<OP_A, OP_XY>>)
// A0
...
OP(JMP_INDLONG) OP(OpCmp<AddrAbsX<OP_A, OP_XY>>) OP(OpDecMem<AddrAbsX<OP_A, OP_XY>>) OP(OpCmp<AddrAbsLongX<OP_A, OP_XY>>)
// E0
...
OP(JSR_INDABSX) OP(OpSbc<AddrAbsX<OP_A, OP_XY>>) OP(OpIncMem<AddrAbsX<OP_A, OP_XY>>) OP(OpSbc<AddrAbsLongX<OP_A, OP_XY>>)
},
// 6502 Native
#define NYI() 0,
{
...
// 10
OP(BPL) OP(OpOr<AddrDirectIndirectY<OP_A, OP_XY, true>>) NYI() NYI()
...
NYI() OP(OpOr<AddrAbsX<OP_A, OP_XY>>) OP(OpAsl<AddrAbsX<OP_A, OP_XY>>) NYI()
// 20
...
// 30
OP(BMI) OP(OpAnd<AddrDirectIndirectY<OP_A, OP_XY, true>>) NYI() NYI()
...
NYI() OP(OpAnd<AddrAbsX<OP_A, OP_XY>>) OP(OpRol<AddrAbsX<OP_A, OP_XY>>) NYI()
// 40
...
// 50
OP(BVC) OP(OpXor<AddrDirectIndirectY<OP_A, OP_XY, true>>) NYI() NYI()
...
NYI() OP(OpXor<AddrAbsX<OP_A, OP_XY>>) OP(OpLsr<AddrAbsX<OP_A, OP_XY>>) NYI()
// 60
...
NYI() OP(OpAdc<AddrAbsX<OP_A, OP_XY>>) OP(OpRor<AddrAbsX<OP_A, OP_XY>>) NYI()
// 80
...
OP(STY<AddrAbs<OP_A, OP_XY>>) OP(STA<AddrAbs<OP_A, OP_XY>>) OP(STX<AddrAbs<OP_A, OP_XY>>) OP(STA<AddrAbsLong<OP_A, OP_XY>>)
// 90
OP(BCC) OP(STA<AddrDirectIndirectY<OP_A, OP_XY, true>>) NYI() NYI()
OP(STY<AddrDirectX<OP_A, OP_XY, true>>) OP(STA<AddrDirectX<OP_A, OP_XY, true>>) OP(STX<AddrDirectY<OP_A, OP_XY, true>>) NYI()
// 98
OP(TYA<OP_A, OP_XY>) OP(STA<AddrAbsY<OP_A, OP_XY>>) OP(TXS<true>) NYI()
NYI() OP(STA<AddrAbsX<OP_A, OP_XY>>) NYI() NYI()
// A0
...
// B0
OP(BCS) OP(LDA<AddrDirectIndirectY<OP_A, OP_XY, true>>) NYI() NYI()
...
// D0
OP(BNE) OP(OpCmp<AddrDirectIndirectY<OP_A, OP_XY, true>>) NYI() NYI()
...
NYI() OP(OpCmp<AddrAbsX<OP_A, OP_XY>>) OP(OpDecMem<AddrAbsX<OP_A, OP_XY>>) NYI()
// E0
...
// F0
OP(BEQ) OP(OpSbc<AddrDirectIndirectY<OP_A, OP_XY, true>>) NYI() NYI()
...
NYI() OP(OpSbc<AddrAbsX<OP_A, OP_XY>>) OP(OpIncMem<AddrAbsX<OP_A, OP_XY>>) NYI()
},
#undef OP_XY
#undef OP_A
